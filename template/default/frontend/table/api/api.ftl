...
return service.post('/${functionName}/entityPage', queryForm ? queryForm : {})
}

// 简单列表
export const ${functionName}EntityListApi = (queryForm?: any) => {
return service.post('/${functionName}/entityList', queryForm ? queryForm : {})
}

// 复杂分页
export const ${functionName}VOPageApi = (queryForm?: any) => {
return service.post('/${functionName}/voPage', queryForm ? queryForm : {})
}

// 复杂列表
export const ${functionName}VOListApi = (queryForm?: any) => {
return service.post('/${functionName}/voList', queryForm ? queryForm : {})
}
