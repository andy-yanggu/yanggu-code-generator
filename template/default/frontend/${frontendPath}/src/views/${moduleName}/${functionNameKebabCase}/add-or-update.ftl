    ...
    <el-dialog v-model="visible" :title="!state.dataForm.id ? '新增' : '修改'" :close-on-click-modal="false">
        ...
        <#list formList as field>
            ...
            <#elseif field.formType == 'select'>
                <el-select v-model="state.dataForm.${field.attrName}" clearable filterable placeholder="请选择${field.fieldComment!}">
...
import { ${functionName}DetailApi, ${functionName}SubmitApi } from '@/api/${moduleName}/${functionNameKebabCase}'
