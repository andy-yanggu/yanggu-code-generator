<template>
	...
	<el-drawer v-model="templateTreeData.visible" :title="`模板配置（${templateGroupName}）`" size="100%" :modal="false" :before-close="handleClose">
		<el-splitter style="height: 100%">
			<!-- 左侧：树结构 -->
			<el-splitter-panel collapsible size="30%" style="overflow: hidden"> </el-splitter-panel>
			<!-- 右侧：模板编辑 -->
			<el-splitter-panel>
				<el-container>
					<!-- 头部操作区域 -->
...
import { Back, CloseBold, DocumentChecked, Edit, Remove, Right } from '@element-plus/icons-vue'
