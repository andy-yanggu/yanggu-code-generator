...
// 批量删除
export const fieldTypeDeleteListApi = (idList: number[]) => {
...
// 批量查询
export const fieldTypeDetailListApi = (idList: number[]) => {
	return service.post('/fieldType/detailList', idList)
}

// 简单分页
export const fieldTypeEntityPageApi = (queryForm?: any) => {
	return service.post('/fieldType/entityPage', queryForm ? queryForm : {})
}

// 简单列表
export const fieldTypeEntityListApi = (queryForm?: any) => {
	return service.post('/fieldType/entityList', queryForm ? queryForm : {})
}

// 复杂分页
export const fieldTypeVOPageApi = (queryForm?: any) => {
	return service.post('/fieldType/voPage', queryForm ? queryForm : {})
}

// 复杂列表
export const fieldTypeVOListApi = (queryForm?: any) => {
	return service.post('/fieldType/voList', queryForm ? queryForm : {})
}
