...
// 批量删除
export const templateDeleteListApi = (idList: number[]) => {
...
// 批量查询
export const templateDetailListApi = (idList: number[]) => {
	return service.post('/template/detailList', idList)
}

// 简单分页
export const templateEntityPageApi = (queryForm?: any) => {
	return service.post('/template/entityPage', queryForm ? queryForm : {})
}

// 简单列表
export const templateEntityListApi = (queryForm?: any) => {
	return service.post('/template/entityList', queryForm ? queryForm : {})
}

// 复杂分页
export const templateVOPageApi = (queryForm?: any) => {
	return service.post('/template/voPage', queryForm ? queryForm : {})
}

// 复杂列表
export const templateVOListApi = (queryForm?: any) => {
	return service.post('/template/voList', queryForm ? queryForm : {})
}
