...
// 批量删除
export const projectDeleteListApi = (idList: number[]) => {
...
// 批量查询
export const projectDetailListApi = (idList: number[]) => {
	return service.post('/project/detailList', idList)
}

// 简单分页
export const projectEntityPageApi = (queryForm?: any) => {
	return service.post('/project/entityPage', queryForm ? queryForm : {})
}

// 简单列表
export const projectEntityListApi = (queryForm?: any) => {
	return service.post('/project/entityList', queryForm ? queryForm : {})
}

// 复杂分页
export const projectVOPageApi = (queryForm?: any) => {
	return service.post('/project/voPage', queryForm ? queryForm : {})
}

// 复杂列表
export const projectVOListApi = (queryForm?: any) => {
	return service.post('/project/voList', queryForm ? queryForm : {})
}

export const projectTableListApi = (queryForm?: any) => {
	return service.post('/project/tableList', queryForm ? queryForm : {})
}
