...
// 批量删除
export const baseClassDeleteListApi = (idList: number[]) => {
...
// 批量查询
export const baseClassDetailListApi = (idList: number[]) => {
	return service.post('/baseClass/detailList', idList)
}

// 简单分页
export const baseClassEntityPageApi = (queryForm?: any) => {
	return service.post('/baseClass/entityPage', queryForm ? queryForm : {})
}

// 简单列表
export const baseClassEntityListApi = (queryForm?: any) => {
	return service.post('/baseClass/entityList', queryForm ? queryForm : {})
}

// 复杂分页
export const baseClassVOPageApi = (queryForm?: any) => {
	return service.post('/baseClass/voPage', queryForm ? queryForm : {})
}

// 复杂列表
export const baseClassVOListApi = (queryForm?: any) => {
	return service.post('/baseClass/voList', queryForm ? queryForm : {})
}
